...
from (
    values
        ('electron', 'Electron', 'https://img.shields.io/badge/Electron-47848F?style=for-the-badge&logo=electron&logoColor=white', 'Experienced', 'Other Tools'),
        ('splunk', 'Splunk', 'https://img.shields.io/badge/Splunk-000000?style=for-the-badge&logo=splunk&logoColor=white', 'Exposed', 'DevOps'),
        ('grafana', 'Grafana', 'https://img.shields.io/badge/Grafana-F46800?style=for-the-badge&logo=grafana&logoColor=white', 'Exposed', 'DevOps'),
        ('ssh', 'SSH', 'https://img.shields.io/badge/SSH-222222?style=for-the-badge&logo=openssh&logoColor=white', 'Exposed', 'DevOps'),
        ('github-copilot', 'GitHub Copilot', 'https://img.shields.io/badge/GitHub_Copilot-000000?style=for-the-badge&logo=githubcopilot&logoColor=white', 'Experienced', 'AI Tools'),
        ('claude-code', 'Claude Code', 'https://img.shields.io/badge/Claude_Code-D97757?style=for-the-badge&logo=anthropic&logoColor=white', 'Experienced', 'AI Tools')
